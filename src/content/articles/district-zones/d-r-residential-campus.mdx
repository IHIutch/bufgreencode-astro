...
<FigureImg caption="D-R Residential Campus">
  ![D-R Residential Campus](/assets/images/4-1/4-1.png)
</FigureImg>
...
1 The maximum height may be increased to up to 1 times the height of the
widest adjacent thoroughfare, plus 1' for each 1' of upper story stepback, only with
approval of City Planning Board as part of major site plan review.
